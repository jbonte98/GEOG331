...
dirR <- "/Users/jeremybonte/Desktop/Geography/GEOG331/activity7/oneida"
...
allbandsCloudf <- stack(allbandsCloud[[1]],allbandsCloud[[2]],allbandsCloud[[3]],allbandsCloud[[4]],allbandsCloud
                        [[5]],allbandsCloud[[6]],allbandsCloud[[7]],allbandsCloud[[8]],allbandsCloud[[9]])
...
rasterAgreement <- abs(nnet_prediction - rf_prediction)
plot(rasterAgreement)
mtext("Difference in predictions", side=3,cex=2, line=-8)
#### Question 6 ####
rf_errorM$table
nn_errorM$table
#### Question 7 ####
