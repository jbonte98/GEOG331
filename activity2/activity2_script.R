...
datW <- read.csv("y:\\Students\\jbonte\\a02\\2011124.csv")
...
#pnrom with 5 gives me all probability (area of the curve) below 5 and above 0
pnorm(5,
      mean(datW$TAVE[datW$siteN == 1],na.rm=TRUE),
